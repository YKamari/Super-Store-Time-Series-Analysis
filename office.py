...
if st.button("predict"):
    ...
    # Generate forecasts
    sarima_pred = sarima_model.get_forecast(steps=num_of_months)

    # Extract prediction values
    sarima_pred_df = pd.DataFrame({'Order Date': sarima_pred.index, 'yhat': sarima_pred.predicted_mean.values})
